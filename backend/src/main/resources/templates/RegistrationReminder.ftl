...
<center style="width: 100%; background-color: #f1f1f1;">
    ...
    <div style="max-width: 1000px; margin: 0 auto;" class="email-container">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                                <div class="text">
                                    <h2>Blíží se termín Vašeho očkování</h2>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">
                                <div class="text-author">
                                    <p>Dobrý den,</p>
                                    <p>
                                        připomínáme, že termín Vašeho očkování v místě ${emailRequestDto.location.address},
                                        dne ${emailRequestDto.slot.date()} v ${emailRequestDto.slot.time()} se blíží. Nezapomeňte na něj, prosím.
                                    </p>
            ...
            <tr>
                <td valign="middle" class="hero bg_white" style="padding: 0 0 4em 0;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 0 2.5em; text-align: center; padding-bottom: 1em;">
                                <div class="text">
                                    <h3>Vámi zadané údaje</h3>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">
                                <div class="text-author">
                                    <ul style="list-style-type: none;">
                                        <li>
                                            Jméno: ${emailRequestDto.firstName}
                                        </li>
                                        <li>
                                            Přijmení: ${emailRequestDto.lastName}
                                        </li>
                                        <li>
