-- initial question data, noinspection because those values will be generated by the database
-- we put there hardcoded ids for testing
...
VALUES ('9a5587a1-dc43-49f3-9847-b736127c9e39', 'is_sick', 'Cítíte se v tuto chvílí nemocný/á?', ''),
       ...
       ('f4ca8d25-faaa-4b2f-abc2-3d7a8702d4a3', 'is_vaccinated_in_last_two_weeks',
        'Absolvoval/a jste v posledních dvou týdnech nějaké jiné očkování?', '');
